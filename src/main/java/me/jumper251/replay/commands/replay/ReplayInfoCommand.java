    ...
    public boolean execute(CommandSender cs, Command cmd, String label, String[] args) {
        ...
        if (ReplaySaver.exists(name)) {
            ...
            ReplaySaver.load(name, replay -> {
                ReplayInfo info = replay.getReplayInfo() != null ? replay.getReplayInfo() : new ReplayInfo(replay.getId(), replay.getData().getCreator(), null, ConfigManager.RECORD_COMPRESSION.toInt(), replay.getData().getDuration());
